declare namespace ymaps {
  ...
  type ObjectManagerCollectionType = {
    type: 'FeatureCollection',
    features: ObjectManagerFeatureType[]
  };

  class ObjectManager {
    constructor(options?: ObjectManagerPropsType);
    add(data: ObjectManagerFeatureType | ObjectManagerCollectionType): void;
    remove(id: Array<number|string>): void;
    removeAll(): void;
  }
  ...
  namespace map {
    ...
    class GeoObjects implements IGeoObjectCollection {
      ...
      add(child: IGeoObject|IObjectManager, index?: number): this;
